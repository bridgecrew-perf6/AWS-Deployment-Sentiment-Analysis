...
# **Answer:** Articles and vowels are removed using NLTK. all charachters are coverted to lower case and strings are converted into lists.
...
# **Answer:** 'movi', 'film', 'one', 'like', 'time' are highly used words which makes sense because we are taking movie reviews data.
...
print("len of a review",len(train_X[25]))
print(train_X[25])
...
# **Answer:** LSTM model gives very good accuracy compared to XGBoost model due to its memory cell allocation methods but XGBoost is more robust model compared to LSTM.
...
# **Screenshot:** Attached in the github file
# 
# **Answer:** Gave the corerct predictions value
